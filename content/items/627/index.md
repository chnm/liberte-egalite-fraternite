...
dublin_core:
  ...
  Description:
    - html: true
      text: Composed by J.M. Souriguieres, a parisian dramatist, and Pierre Gaveaux, an actor, this song demands revenge for the crimes and bloodshed of the Terror. It was quickly adopted as an anthem by the "gilded youth" of the Thermidoran Reaction, who sang it in opposition to singers of the <em>Marseillaise</em>.
  Identifier:
    - html: false
      text: '626'
  Relation:
    - html: false
      text: http://chnm.gmu.edu/revolution/d/626/
  Title:
    - html: true
      text: The Alarm of the People
featured: false
files:
  - fullsize:
    id: 313
    mime: audio/mpeg
    original_filename: http://chnm.gmu.edu/revolution/files/original/f0708edbb4da043debf54061e85a4afd.mp3
    thumb:
    url: https://revolution.chnm.org/files/original/61a714b6b864e6cbc9e8e5d07ce4635d.mp3
geo:
id: 627
item_type: Sound
item_type_metadata:
  ...
  Transcription:
    - html: true
      text: |-
        <table><tbody><tr><td>Réveil du peuple
