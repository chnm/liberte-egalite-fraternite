...
dublin_core:
  ...
  Description:
    - html: true
      text: An observer of Jacobin club meetings in 1791, in the passage below, describes somewhat disorderly debates, in which speakers are shouted down from the rostrum and women participate openly. This is indicative of what this author sees as the "ungovernable" situation in Paris.
  Identifier:
    - html: false
      text: '402'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/402/
  Source:
    - html: true
      text: 'John Moore,<i> Mordaunt: Sketches of Life, Characters and Manners in Various Countries, including the Memoirs of a French Lady</i> (London: 1800).'
  Title:
    - html: true
      text: Women at the Jacobins
featured: false
files: []
geo:
id: 448
