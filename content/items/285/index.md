...
dublin_core:
  ...
  Description:
    - html: true
      text: In this excerpt, Rainsford describes the divisive effects of the <i>Declaration of Rights</i> of the Blacks among the various racial/social groupings.
  Identifier:
    - html: false
      text: '604'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/604/
  Source:
    - html: true
      text: 'Marcus Rainsford, <i>An Historical Account of the Black Empire of Hayti: Comprehending a View of the Principal Transactions in the Revolution of Saint-Domingo; with its Ancient and Modern State</i> (London, 1805), 110–13.'
  Title:
    - html: true
      text: A Divided Elite from <i>An Historical Account of the Black Empire of Hayti</i>
featured: false
files: []
geo:
id: 285
...
{{< raw >}}
In this excerpt, Rainsford describes the divisive effects of the <i>Declaration of Rights</i> of the Blacks among the various racial/social groupings.
{{< /raw >}}
