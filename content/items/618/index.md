...
dublin_core:
  ...
  Description:
    - html: true
      text: A hymn written by Joseph Gossec to celebrate national unity on the first anniversary of the taking of the Bastille. Combining old and new, Gossec set a traditional Latin text to music scored for wind instruments (rather than the common organ), the sound of which carried well at the outdoor festival.
  Identifier:
    - html: false
      text: '614'
  Relation:
    - html: false
      text: http://chnm.gmu.edu/revolution/d/614/
  Title:
    - html: true
      text: Te Deum for the Federation of July 14, 1790 at the Champ de Mars
featured: false
files:
  - fullsize:
    id: 304
    mime: audio/mpeg
    original_filename: http://chnm.gmu.edu/revolution/files/original/d001891a2a68a211a24317ca4e4fd036.mp3
    thumb:
    url: https://revolution.chnm.org/files/original/6c810da2ea8754e6a877d7de1109ba5c.mp3
geo:
id: 618
item_type: Sound
item_type_metadata:
