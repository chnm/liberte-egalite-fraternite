...
dublin_core:
  Date:
    - html: false
      text: November 28, 1790
  Description:
    - html: true
      text: One of the targets of the left was the officer corps. Recruited from the aristocracy, the military leadership was, of course, suspect. When early battles went poorly, suspicion, justifiable or not, only mounted. Such circumstances led to even more emigration by officers, generating an upward spiral of mutual hostility.
  Identifier:
    - html: false
      text: '496'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/496/
  Source:
    - html: true
      text: <i>L'Orateur du peuple,</i> vol. 3, no. 13 (28 November 1790), 97–104.
  Title:
    - html: true
      text: Ex–Nobles Targeted in the Press—Military Nobility
featured: false
files: []
geo:
id: 367
...
tags:
  ...
  - Public Opinion
  - Text
title: Ex–Nobles Targeted in the Press—Military Nobility
type: items
url: /d/496/
---
