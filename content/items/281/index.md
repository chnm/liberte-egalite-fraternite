...
dublin_core:
  ...
  Description:
    - html: true
      text: In this excerpt, Rainsford continues to exhalt the qualities of L’Ouverture while criticizing French behavior in the attempted reconquest of the island under Napoleon.
  Identifier:
    - html: false
      text: '608'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/608/
  Source:
    - html: true
      text: 'Marcus Rainsford, <i>An Historical Account of the Black Empire of Hayti: Comprehending a View of the Principal Transactions in the Revolution of Saint-Domingo; with its Ancient and Modern State</i> (London, 1805), 264–65.'
  Title:
    - html: true
      text: The French Return from <i>An Historical Account of the Black Empire of Hayti</i>
featured: false
files: []
geo:
id: 281
