...
dublin_core:
  ...
  Description:
    - html: true
      text: Village priests served as community leaders in a variety of respects, including keeping a register of births, marriages, and deaths. One such curate, the abbé Lefeuvre, also included in his register impressions of life during the severe winter of 1709, which give a sense of the difficult and fragile lives of the poor in rural towns in the eighteenth century.
  Identifier:
    - html: false
      text: '353'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/353/
  Rights:
    - html: false
      text: Web version password protected
  Source:
    - html: true
      text: 'Jeffry Kaplow, ed., <em>France on the Eve of Revolution: A Book of Readings</em> (New York: John Wiley &amp; Sons, 1971), 9–12. This material is used by permission of John Wiley &amp; Sons, Inc.'
  Title:
    - html: true
      text: '! Poverty Observed: Journal of a Country Priest'
featured: false
files: []
geo:
id: 497
