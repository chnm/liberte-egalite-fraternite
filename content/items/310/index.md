...
dublin_core:
  ...
  Description:
    - html: true
      text: Many American cities met the emergency needs of an influx of white refugees who fled the uprising.
  Identifier:
    - html: false
      text: '574'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/574/
  Source:
    - html: true
      text: '<i>The Pennsylvania Gazette</i> (Philadelphia), 17 July 1793; available on cd-rom (Accessible Archives: Wilmington, Del., distributed by Scholarly Resources, 1998).'
  Title:
    - html: true
      text: '<i>The Pennsylvania Gazette</i>: White Refugees (17 July 1793)'
featured: false
files: []
geo:
id: 310
