...
dublin_core:
  ...
  Description:
    - html: true
      text: After a three–month trial, the magistrates found Damiens guilty of parricide against the person of the King on 26 March 1757. In a final interrogation, Damiens is once again asked about accomplices. He then denies having them.
  Identifier:
    - html: false
      text: '241'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/241/
  Source:
    - html: true
      text: 'Anonymous, <i>Pièces originales et procédures du procès, fait à Robert-François Damiens</i> (Paris: Pierre Guillaume Simon, 1757).'
  Title:
    - html: true
      text: Decree of the <i>Parlement</i> of Paris against Robert–François Damiens
featured: false
files: []
geo:
id: 609
