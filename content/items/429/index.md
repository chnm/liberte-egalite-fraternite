...
dublin_core:
  ...
  Description:
    - html: true
      text: In response to the "Padua Circular," King Louis’s brother, the Count of Artois, a leader of the<i> émigré </i>nobles, expressed his support for Emperor Leopold II of Austria. Leopold, in conjunction with Prussian King Frederick–William III, then issued this "Declaration of Pillnitz"; the "resolution to act quickly" was perceived as a declaration of war on France for the purpose of ending the Revolution, even though neither Austria nor Prussia was displeased by French weakness.
  Identifier:
    - html: false
      text: '421'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/421/
  Source:
    - html: true
      text: 'George F. de Martens, <i>Recueil des traites</i>, 2d ed., vol. 5 (Gottingue, 1917), 260. Translated by <i>Exploring the French Revolution </i>project staff from original documents in French found in J.M. Roberts, <i>French Revolution Documents</i>, vol. 1 (Oxford: Basil Blackwell, 1966), 439.'
  Title:
    - html: true
      text: '"The Declaration of Pillnitz"'
featured: false
files: []
geo:
id: 429
