...
dublin_core:
  ...
  Description:
    - html: true
      text: In response to his defeat by Napoleon, Prussian King Frederick William I, pushed by his ministers, initiated a series of reforms intended to modernize property relationships and the administration of the state. This edict abolished serfdom.
  Identifier:
    - html: false
      text: '517'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/517/
  Source:
    - html: true
      text: 'James H. Robinson, ed., <i>Translations and Reprints from the Original Sources of European History, vol II, no. 2: The Napoleonic Period</i> (Philadelphia: University of Pennsylvania, 1902), pp. 27-30.'
  Title:
    - html: true
      text: The Prussian Reform Edict (9 October 1807)
featured: false
files: []
geo:
id: 351
