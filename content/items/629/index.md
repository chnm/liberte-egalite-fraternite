...
dublin_core:
  Description:
    - html: true
      text: This song was composed for one of the many Directorial festivals that were not overtly political. Several, like the festival for which this song was composed, celebrated important moments in the life cycle.
  Identifier:
    - html: false
      text: '619'
  Relation:
    - html: false
      text: http://chnm.gmu.edu/revolution/d/619/
  Title:
    - html: true
      text: Song for the Festival of Old Age
featured: false
files:
  - fullsize:
    id: 315
    mime: audio/mpeg
    original_filename: http://chnm.gmu.edu/revolution/files/original/64b3cb09131fd56649536d6ec44fbd8f.mp3
    thumb:
    url: https://revolution.chnm.org/files/original/ce93478bbdf1b1a2f97814c9425af1fe.mp3
geo:
id: 629
item_type: Sound
item_type_metadata:
