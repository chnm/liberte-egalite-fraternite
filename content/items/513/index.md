...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/337/
  Source:
    - html: true
      text: P. J. Labourie, <i>The Coffee Planter of Saint-Domingo</i> (London, 1798), 157–70.
  Title:
    - html: true
      text: The Coffee Planter of Saint Domingo (London, 1798)
featured: false
files: []
geo:
id: 513
...
{{< raw >}}
Laborie provides the perspective of the planter himself. He gives a detailed description of the organization of slave labor in the production of coffee. Although he shared quite negative views of the African slaves, he recognized that extreme brutality would diminish the capacity of the slaves to work.
{{< /raw >}}
