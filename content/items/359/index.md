...
dublin_core:
  ...
  Description:
    - html: true
      text: When he made himself emperor, Napoleon clearly rejected the republican form of government. Here he tries to claim that hereditary government is necessary in a large state. The presence of the pope at his coronation seemed to confer legitimacy on the act.
  Identifier:
    - html: false
      text: '508'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/508/
  Source:
    - html: true
      text: 'James H. Robinson and Charles A. Beard, eds., Readings in Modern European History, vol. 1 (Boston: Ginn and Company, 1908), pp. 334-336.'
  Title:
    - html: true
      text: Napoleon’s Reasons for Making Himself Emperor (December 1804)
featured: false
files: []
geo:
id: 359
