...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/564/
  Source:
    - html: true
      text: 'Immanuel Kant, <i>The Contest of Faculties, </i>in Hans Reiss, ed.<i>, Kant: Political Writings, </i>2d ed. (Cambridge: Cambridge University Press, 1991) (Der Streit der Fakultäten [1798]), 182–83. Reprinted with the permission of Cambridge University Press.'
  Title:
    - html: true
      text: Kant, <i>The Contest of Faculties</i>
featured: false
files: []
geo:
id: 320
