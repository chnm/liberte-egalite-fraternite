...
dublin_core:
  Date:
    - html: false
      text: September 8, 1791
  Description:
    - html: true
      text: Fears about Marie Antoinette’s intentions and actions were not baseless. Although inexperienced in the new style of politics, Marie Antoinette did see a need for help from abroad if the monarchy was to stop or reverse the course of the Revolution, which she thought to be getting out of control. She wrote this letter to her brother Leopold II, Emperor of the large Habsburg Empire in central Europe, describing the Revolution as she saw it and asking for his help to end it.
  Identifier:
    - html: false
      text: '331'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/331/
  Source:
    - html: true
      text: "Maxime de la Rocheterie and the Marquis de Beaucourt, <i>Marie-Antoinette, Lettres; réceuil des lettres authentiques de la reine,</i> vol. 2 (Paris: Société d'histoire contemporaine, 1896), 284–304."
  Title:
    - html: true
      text: Marie Antoinette’s View of the Revolution (8 September 1791)
featured: false
files: []
geo:
id: 519
...
item_type_metadata:
  ...
  Text:
    - html: true
      text: |-
        <p>Only the Emperor can put an end to the troubles caused by the French Revolution.</p>
