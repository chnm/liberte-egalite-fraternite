...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/315/
  Source:
    - html: true
      text: 'Félix-Sébastien Feuillet de Conches, ed., <i>Louis XVI, Marie-Antoinette et Madame Élisabeth, </i>vol. 2 (Paris: Plon, 1864), 366–75.'
  Title:
    - html: true
      text: Louis Accepts the Constitution (14–25 September 1791)
featured: false
files: []
geo:
id: 535
