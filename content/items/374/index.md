...
dublin_core:
  Date:
    - html: false
      text: November 17, 1793
  Description:
    - html: true
      text: When a group of women appeared at City Hall wearing red liberty caps, Pierre–Gaspard Chaumette denounced them and all political activism by women. He held out the examples of Madame Roland and Olympe de Gouges as warnings.
  Identifier:
    - html: false
      text: '489'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/489/
  Source:
    - html: true
      text: "The materials listed below appeared originally in <i>The French Revolution and Human Rights: A Brief Documentary History, </i>translated, edited, and with an introduction by Lynn Hunt (Bedford/St. Martin's: Boston/New York), 1996, 138–39."
  Title:
    - html: true
      text: Chaumette, Speech at City Hall Denouncing Women’s Political Activism (17 November 1793)
featured: false
files: []
geo:
id: 374
