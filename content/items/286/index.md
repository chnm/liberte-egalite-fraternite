...
dublin_core:
  ...
  Description:
    - html: true
      text: Rainsford wrote one of the first favorable accounts of the Haitian Revolution. He blamed the colonists for refusing to alter the slave system. Our excerpts begin with reactions to the revolution in mainland France in 1789 and continue through the death in prison in France of Toussaint L’Ouverture in 1803.
  Identifier:
    - html: false
      text: '603'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/603/
  Source:
    - html: true
      text: 'Marcus Rainsford, <i>An Historical Account of the Black Empire of Hayti: Comprehending a View of the Principal Transactions in the Revolution of Saint-Domingo; with its Ancient and Modern State</i> (London, 1805), 106–8.'
  Title:
    - html: true
      text: Discontent Spreads from <i>An Historical Account of the Black Empire of Hayti</i>
featured: false
files: []
geo:
id: 286
