...
dublin_core:
  ...
  Description:
    - html: true
      text: This aria from the Gretry opera,<em> Richard the Lion–Hearted, </em>was adopted by royalists during the early years of the Revolution. The song’s accusation that the king had been abandoned by all but his most devoted followers made it a suitable counter–revolutionary anthem.
  Identifier:
    - html: false
      text: '622'
  Relation:
    - html: false
      text: http://chnm.gmu.edu/revolution/d/622/
  Title:
    - html: true
      text: Oh Richard, Oh, My King!
featured: false
files:
  - fullsize:
    id: 306
    mime: audio/mpeg
    original_filename: http://chnm.gmu.edu/revolution/files/original/0cf35804a9a73cf23981d8d0b36df093.mp3
    thumb:
    url: https://revolution.chnm.org/files/original/e20f382dbbcd61ca21c8a350d6ed42fb.mp3
geo:
id: 620
item_type: Sound
item_type_metadata:
