...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/264/
  Source:
    - html: true
      text: Anonymous, Motion curieuse des dames de la place Maubert (Paris:Guillaume, 1785)..
  Title:
    - html: true
      text: <i>Curious Proposal of the Women of the Maubert Marketplace</i> (1785)
featured: false
files: []
geo:
id: 586
