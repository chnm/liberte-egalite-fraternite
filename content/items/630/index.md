...
dublin_core:
  ...
  Description:
    - html: true
      text: This hymn was performed at the state funeral held in Paris for Lazare Hoche. Only twenty–nine when he died, Hoche was already famous for his daring military leadership against the Prussians in 1793 and for the role he played in helping to quell counter–revolution in the west of France.
  Identifier:
    - html: false
      text: '620'
  Relation:
    - html: false
      text: http://chnm.gmu.edu/revolution/d/620/
  Title:
    - html: true
      text: Funeral Hymn for General Hoche
featured: false
files:
  - fullsize:
    id: 316
    mime: audio/mpeg
    original_filename: http://chnm.gmu.edu/revolution/files/original/a5c6fdc0267b4a03817a0a8a512e886a.mp3
    thumb:
    url: https://revolution.chnm.org/files/original/5a5d884c81f387a565cbe63a8a182a21.mp3
geo:
id: 630
item_type: Sound
item_type_metadata:
  ...
  Transcription:
    - html: true
      text: |-
        <table><tbody><tr><td>Hymne funèbre sur la mort du Général Hoche.
