...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/313/
  Source:
    - html: true
      text: 'Georges Pernoud and Sabine Flaissier, <i>The French Revolution</i>, translated by Richard Graves (New York: Capricorn Books, 1970), 87–90.'
  Title:
    - html: true
      text: The Flight to Varennes (21–23 June 1791)
featured: false
files: []
geo:
id: 537
