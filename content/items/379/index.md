...
dublin_core:
  ...
  Description:
    - html: true
      text: In the discussion of a new constitution in April 1793, Jean–Denis Lanjuinais spoke for the constitutional committee. He admitted that the question of women’s rights had aroused controversy.
  Identifier:
    - html: false
      text: '484'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/484/
  Source:
    - html: true
      text: "The materials listed below appeared originally in <i>The French Revolution and Human Rights: A Brief Documentary History, </i>translated, edited, and with an introduction by Lynn Hunt (Bedford/St. Martin's: Boston/New York), 1996, 132–35."
  Title:
    - html: true
      text: Discussion of Citizenship under the Proposed New Constitution (29 April 1793)
featured: false
files: []
geo:
id: 379
