...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/262/
  Source:
    - html: true
      text: Anonymous, <i>Essais historiques sur la vie de Marie-Antoinette, d'autriche</i> (London, 1789), 1–69.
  Title:
    - html: true
      text: <i>Historical Essays on the Life of Marie–Antoinette, of Austria</i> (1783)
featured: false
files: []
geo:
id: 588
