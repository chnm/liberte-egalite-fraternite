...
dublin_core:
  ...
  Description:
    - html: true
      text: In his<i> Persian Letters, </i>published anonymously and abroad in 1721, Charles–Louis de Sécondat, Baron de Montesquieu, president of the<i> Parlement </i>of Bordeaux and a noble himself, made a scathing critique of nobility that set the tone for the philosophes’ attack on the inequality of eighteenth–century French society.
  Identifier:
    - html: false
      text: '361'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/361/
  Source:
    - html: true
      text: 'Charles-Louis de Sécondat, Baron de Montesquieu,<i> Persian Letters, </i>no translator listed, 3d ed. (London: J. Torson, 1736), no. 74, 157–58.'
  Title:
    - html: true
      text: Montesquieu’s Attack on the Nobility
featured: false
files: []
geo:
id: 489
