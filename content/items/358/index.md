...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/509/
  Source:
    - html: true
      text: 'Bryant Barrett, trans., <i>The Code Napoleon</i>, verbally translated from the French, 2 vols. (London: W. Reed, 1811), I: 47, 49, 57; II: p. 358.'
  Title:
    - html: true
      text: The French Civil Code (1804)
featured: false
files: []
geo:
id: 358
