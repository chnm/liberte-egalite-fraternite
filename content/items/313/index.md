...
dublin_core:
  ...
  Description:
    - html: true
      text: Moreau de Saint–Méry painted a particularly negative portrait of mulatto women whom he considered to be voluptuaries and a threat to morals and decency.
  Identifier:
    - html: false
      text: '571'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/571/
  Source:
    - html: true
      text: 'Médéric-Louis-Elie Moreau de Saint-Méry, <i>A Civilization That Perished: The Last Years of White Colonial Rule in Haiti, </i>(Philadelphia, published by the author, 1797-1798), translated, abridged, and edited by Ivor D. Spencer, (Lanham, MD: University Press of America, 1985), 81-82.'
  Title:
    - html: true
      text: That Seductive Mulatto Woman
featured: false
files: []
geo:
id: 313
