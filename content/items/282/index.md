...
dublin_core:
  ...
  Description:
    - html: true
      text: Rainsford’s detailed contemporary account of the revolt emphasizes the strenuous yet ultimately unsuccessful mobilization of colonial French resources.
  Identifier:
    - html: false
      text: '607'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/607/
  Source:
    - html: true
      text: 'Marcus Rainsford, <i>An Historical Account of the Black Empire of Hayti: Comprehending a View of the Principal Transactions in the Revolution of Saint-Domingo; with its Ancient and Modern State </i>(London, 1805), 134–39.'
  Title:
    - html: true
      text: The Revolt from <i>An Historical Account of the Black Empire of Hayti</i>
featured: false
files: []
geo:
id: 282
