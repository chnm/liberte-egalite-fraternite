...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/518/
  Source:
    - html: true
      text: 'James H. Robinson, ed., <i>Translations and Reprints from the Original Sources of European History, vol II, no. 2: The Napoleonic Period</i> (Philadelphia: University of Pennsylvania, 1902), pp. 19-21.'
  Title:
    - html: true
      text: The Continental System (1806)
featured: false
files: []
geo:
id: 350
