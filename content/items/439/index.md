...
dublin_core:
  ...
  Description:
    - html: true
      text: In this article from April 1791, Fréron, a journalist allied to the radical Jean–Paul Marat, focuses on foreign enemies.
  Identifier:
    - html: false
      text: '411'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/411/
  Source:
    - html: true
      text: <i>Orateur du Peuple</i>, vol. 1, no. 6 (April 1791), 44–45.
  Title:
    - html: true
      text: Fear of Aristocratic Politics
featured: false
files: []
geo:
id: 439
