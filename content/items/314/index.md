...
dublin_core:
  ...
  Description:
    - html: true
      text: As many as two–thirds of the slaves in Saint Domingue in 1789 had been born in Africa, but by that time a significant number of Africans or children of Africans had become free. Here Moreau de Saint–Méry details the origins of this pivotal group.
  Identifier:
    - html: false
      text: '570'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/570/
  Source:
    - html: true
      text: 'Médéric-Louis-Elie Moreau de Saint-Méry, <i>A Civilization That Perished: The Last Years of White Colonial Rule in Haiti, </i>(Philadelphia, published by the author, 1797-1798), translated, abridged, and edited by Ivor D. Spencer, (Lanham, MD: University Press of America, 1985, 73-75.'
  Title:
    - html: true
      text: 'Saint Domingue: The Freedmen'
featured: false
files: []
geo:
id: 314
