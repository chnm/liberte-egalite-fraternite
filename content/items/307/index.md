...
dublin_core:
  Date:
    - html: false
      text: December 13, 1797
  Description:
    - html: true
      text: In the United States, vigilance remained at a high pitch as slaveowners dreaded the possible importation of rebellion from Saint Domingue.
  Identifier:
    - html: false
      text: '577'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/577/
  Source:
    - html: true
      text: '<i>The Pennsylvania Gazette</i> (Philadelphia), 13 December 1797; available on cd-rom (Accessible Archives: Wilmington, Del., distributed by Scholarly Resources, 1998), 13 December 1797.'
  Title:
    - html: true
      text: '<i>The Pennsylvania Gazette</i>: U.S. Vigilance (13 December 1797)'
featured: false
files: []
geo:
id: 307
