...
dublin_core:
  ...
  Description:
    - html: true
      text: Jardin Ainé (the elder) was responsible for Napoleon’s horse and had a firsthand view of the momentous events that definitively ended Napoleon’s career.
  Identifier:
    - html: false
      text: '528'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/528/
  Source:
    - html: true
      text: 'Mackenzie Macbride, ed., With Napoleon at Waterloo and other Unpublished Documents of the Waterloo and Pennsular Campaigns (Philadelphia: J.B. Lippincott Co., 1911), pp. 181-185.'
  Title:
    - html: true
      text: The Battle of Waterloo as Recounted by one of Napoleon’s Personal Aides (June 1815)
featured: false
files: []
geo:
id: 341
