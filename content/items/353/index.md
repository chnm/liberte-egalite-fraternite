...
dublin_core:
  ...
  Description:
    - html: true
      text: The “French” armies included units from many allied states. Excerpted below is the memoir of an ordinary foot soldier in Napoleon’s army. Jakob Walter came from Württemburg, one of the medium-size German states allied with Napoleon. He fought against other German states, in this instance Prussia.
  Identifier:
    - html: false
      text: '515'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/515/
  Source:
    - html: true
      text: 'Marc Raeff, ed., The Diary of a Napoleonic Foot Soldier: Jakob Walter (New York: Doubleday, 1991), pp. 3, 10-13.'
  Title:
    - html: true
      text: An Ordinary Soldier’s Account (1806)
featured: false
files: []
geo:
id: 353
