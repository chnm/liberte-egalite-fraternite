...
dublin_core:
  ...
  Description:
    - html: true
      text: The commission investigating the October Days took testimony from twenty–five women who had participated, including Marie–Rose Barré, a twenty–year old unmarried lace–worker, whose testimony is excerpted below. Barré had been one of the women chosen to meet directly with the King to present the women’s concerns.
  Identifier:
    - html: false
      text: '388'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/388/
  Source:
    - html: true
      text: From <i>Women in Revolutionary Paris, 1789–1795</i>, edited and translated by Darline Gay Levy, Harriet Branson Applewhite, and Mary Durham Johnson. Copyright 1979 by the Board of Trustees of the University of Illinois. Used with the permission of the University of Illinois Press, 49–50.
  Title:
    - html: true
      text: 'October Days: Deposition of a Marcher'
featured: false
files: []
geo:
id: 462
