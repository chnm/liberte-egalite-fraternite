...
dublin_core:
  ...
  Description:
    - html: true
      text: Gustave Le Bon (1841–1931) disparaged the Revolution and the revolutionary legacy because he distrusted the common person, particularly when making collective decisions. His analysis of revolutionary crowds pictured them as primitive animals devoid of good decision–making abilities who had to be reigned in by a "strong man" or dictatorial figure.
  Identifier:
    - html: false
      text: '628'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/628/
  Source:
    - html: true
      text: 'Gustave Le Bon, <i>The Psychology of Revolution</i>, trans. Bernard Miall (London: T. Fisher Unwin, [1895] 1913), 102–5, 158–60.'
  Title:
    - html: true
      text: Le Bon, <i>The Psychology of Revolution</i>
featured: false
files: []
geo:
id: 274
