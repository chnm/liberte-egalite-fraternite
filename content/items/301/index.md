...
dublin_core:
  ...
  Description:
    - html: true
      text: Ho Chi Minh, the revolutionary name of Nguyen That Thanh (1890–1969), was the leader of the Vietnamese revolution for independence from the French. He was educated in France, where he became a communist. He returned home to fight Japanese occupation during World War II and to lead resistance to the French afterward. He denounced the imperialist deformation of revolutionary principles and explicitly allied himself with the promise of the original French Revolution.
  Identifier:
    - html: false
      text: '583'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/583/
  Source:
    - html: true
      text: 'Ho Chi Minh, <i>On Revolution: Selected Writings, 1920–66</i>, edited and with an introduction by Bernard B. Fall (New York: Frederick A. Praeger, 1967), 143–45. Copyright © Dorothy Fall.'
  Title:
    - html: true
      text: Ho Chi Minh, Declaration of Independence of the Democratic Republic of Viet–Nam
featured: false
files: []
geo:
id: 301
