...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/483/
  Source:
    - html: true
      text: "The materials listed below appeared originally in <i>The French Revolution and Human Rights: A Brief Documentary History, </i>translated, edited, and with an introduction by Lynn Hunt (Bedford/St. Martin's: Boston/New York), 1996, 129–31."
  Title:
    - html: true
      text: Prudhomme, "On the Influence of the Revolution on Women" (12 February 1791)
featured: false
files: []
geo:
id: 380
