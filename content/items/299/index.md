...
dublin_core:
  ...
  Description:
    - html: true
      text: One of the most widely–read authors of the late nineteenth century, Anatole France (1844–1924) saw the humanity of even the most notorious revolutionary figures such as Jean–Paul Marat. Yet, dedicated to the principles of 1789, France preferred the earlier period of the Revolution. Consequently, his treatment of the National Convention is somewhat ironic despite his general support for the Republic.
  Identifier:
    - html: false
      text: '585'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/585/
  Source:
    - html: true
      text: 'Anatole France, <i>The Gods Are Athirst</i>, in <i>The Six Greatest Novels of Anatole France</i>, trans. Wilfrid Jackson (Garden City, N.Y.: Doubleday, Doran &amp; Company, 1918 [1890]), 528–29, 537.'
  Title:
    - html: true
      text: France, <i>The Gods Are Athirst</i>
featured: false
files: []
geo:
id: 299
