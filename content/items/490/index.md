...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/360/
  Source:
    - html: true
      text: François-Marie Arouet,<i> Dictionnaire philosophique</i> (London [Nancy], 1765), 157–60.
  Title:
    - html: true
      text: Voltaire’s Understanding of Inequality
featured: false
files: []
geo:
id: 490
