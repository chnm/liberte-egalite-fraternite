...
dublin_core:
  ...
  Description:
    - html: true
      text: John Stuart Mill (1806–73), an English civil servant and philosopher, was a firm believer in the liberal, democratic, and anti–absolutist elements of the legacy of the Revolution and hoped to extend these concepts as widely as possible. Most famous for <i>On Liberty</i> (1859) and <i>The Subjection of Women</i> (1869), Mill was profoundly influenced by the French Revolution.
  Identifier:
    - html: false
      text: '588'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/588/
  Source:
    - html: true
      text: 'John Stuart Mill, <i>Autobiography and Literary Essays</i>, ed. John M. Robson and Jack Stillinger (Toronto: University of Toronto Press, 1981), 65, 135.'
  Title:
    - html: true
      text: John Stuart Mill on the French Revolution
featured: false
files: []
geo:
id: 296
