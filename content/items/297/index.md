...
dublin_core:
  ...
  Description:
    - html: true
      text: Victor Hugo (1802–85) was an ardent republican and defender of the revolutionary legacy who went into exile during the Second Empire (1852–70). He lived long enough to become an icon of the Third Republic. He portrayed the democratic aspects of the Revolution in glowing, indeed somewhat romanticized terms.
  Identifier:
    - html: false
      text: '587'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/587/
  Source:
    - html: true
      text: 'Victor Hugo,<i> The Complete Works of Victor Hugo: Ninety-Three, </i>vol. 1 (London: Hawarden Press, 1890), 197–98.'
  Title:
    - html: true
      text: Hugo, <i>Ninety–Three</i>
featured: false
files: []
geo:
id: 297
