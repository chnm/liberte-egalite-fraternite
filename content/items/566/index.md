...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/284/
  Source:
    - html: true
      text: "The materials listed below appeared originally in <i>The French Revolution and Human Rights: A Brief Documentary History, </i>translated, edited, and with an introduction by Lynn Hunt (Boston/New York: Bedford/St. Martin's, 1996), 86–88."
  Title:
    - html: true
      text: Clermont–Tonnerre, "Speech on Religious Minorities and Questionable Professions" (23 December 1789)
featured: false
files: []
geo:
id: 566
