...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/351/
  Source:
    - html: true
      text: 'Jules Flammermont,<i> Le Chancelier Maupeou et les parlements</i> (Paris: Alphonse Picard, 1883), 277Ð79.'
  Title:
    - html: true
      text: Edict Creating "Superior Councils" (23 February 1771)
featured: false
files: []
geo:
id: 499
