...
dublin_core:
  ...
  Description:
    - html: true
      text: This project to free the slaves in the French colonies was presented to the National Assembly. The defensive tone and rhetorical structure that emerge in the course of this document demonstrate the power of the interests opposed to even cautious steps toward emancipation.
  Identifier:
    - html: false
      text: '340'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/340/
  Source:
    - html: true
      text: Jean-Louis Viefville des Essars, <i>Discours et projet de loi pour l'affranchissement des negrès ou l'adoucissement de leur régime, et réponse aux objections des colons</i> (Paris, n.d.).
  Title:
    - html: true
      text: Viefville des Essars, <i>On the Emancipation of the Negroes</i> (1790)
featured: false
files: []
geo:
id: 510
