...
dublin_core:
  Description:
    - html: true
      text: Klemens von Metternich, head of the Austrian government and therefore a sharp critic of Napoleon, reported that Napoleon viewed Catholicism in largely utilitarian, even cynical terms.
  Identifier:
    - html: false
      text: '505'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/505/
  Source:
    - html: true
      text: "Clemens Lothar Wenzel, FŸrst von Metternich-Winneburg, Memoirs of Prince Metternich, 1773-1815, ed. Prince Richard Metternich, tr. Mrs. Alexander Napier, 5 vols. (New York: Charles Scribner's Sons, 1880-1882), I: pp. 272-273."
  Title:
    - html: true
      text: Napoleon’s Personal Feelings about Religion
featured: false
files: []
geo:
id: 362
