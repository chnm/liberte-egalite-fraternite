...
dublin_core:
  ...
  Description:
    - html: true
      text: Like his predecessors of earlier generations, playwright Pierre–Augustin Caron de Beaumarchais—who became an important figure of the late Enlightenment because of the controversy surrounding his work <i>The Marriage of Figaro</i> [1784]—believed that a truly rational society would not tolerate arbitrary inequality.
  Identifier:
    - html: false
      text: '362'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/362/
  Source:
    - html: true
      text: Pierre-Augustin Caron de Beaumarchais,<i> La Folle journée ou le marriage de Figaro</i> (Amsterdam, n.p., 1785 [1784]), act 5, scene 3.
  Title:
    - html: true
      text: Beaumarchais’s Understandings of Inequality
featured: false
files: []
geo:
id: 488
