...
dublin_core:
  ...
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/455/
  Source:
    - html: true
      text: 'Anonymous, <i>Correspondance secrète de Charette,</i> vol. 1 (Paris, 1798–99), 19–20. Translated by <i>Exploring the French Revolution </i>project staff from original documents in French found in John Hardman, <i>French Revolution Documents 1792–95</i>, vol. 2 (New York: Barnes &amp; Noble Books, 1973), 423–24.'
  Title:
    - html: true
      text: Louis XVIII to Charette
featured: false
files: []
geo:
id: 405
