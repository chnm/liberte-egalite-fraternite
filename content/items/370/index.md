...
dublin_core:
  ...
  Description:
    - html: true
      text: Once the uprising of May 1795 had been suppressed, the government set up a military tribunal, which gathered denunciations of presumed rioters. This one gives a good sense of the charges made and the kind of language used ("infernal sect of Jacobin terrorists, blood–drinkers, etc.").
  Identifier:
    - html: false
      text: '493'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/493/
  Source:
    - html: true
      text: From <i>Women in Revolutionary Paris, 1789–1795, </i>edited and translated by Darline Gay Levy, Harriet Branson Applewhite, and Mary Durham Johnson. Copyright 1979 by the Board of Trustees of the University of Illinois. Used with the permission of the University of Illinois Press, 292–293.
  Title:
    - html: true
      text: Denunciation of a Woman Participant in the Uprising of May 1795
featured: false
files: []
geo:
id: 370
