...
dublin_core:
  ...
  Description:
    - html: true
      text: 'This article appeared in the newspaper <i>Revolutions of France and Brabant</i>, under the headline: "Horrible maneuvers of the Austrians at the Tuileries Palace to bring civil war to France . . ." and discusses various rumors making the rounds that the King would soon flee France and initiate an invasion led by former aristocrats to undo the evolution. Camile Desmoulins’s reference to the "Austrian Committee" implied that Marie Antoinette was conspiring with other members of her Habsburg family who ruled in Austria.'
  Identifier:
    - html: false
      text: '330'
  Relation:
    - html: false
      text: https://chnm.gmu.edu/revolution/d/330/
  Source:
    - html: true
      text: <i>Les Révolutions de France et de Brabant</i>, no. 18 (June 1791), 137–40.
  Title:
    - html: true
      text: Desmoulins Attacks the Queen (June 1791)
featured: false
files: []
geo:
id: 520
