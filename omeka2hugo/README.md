...
This directory is written by `omeka-to-hugo` for the site **revolution**
(`https://revolution.chnm.org`). It holds everything the converter produces that is *not* part of
